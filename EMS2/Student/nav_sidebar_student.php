<?php
// Student/nav_sidebar_student.php
?>
<nav class="dashboard-navbar">
    <div class="nav-left">
        <button class="menu-toggle" id="menuToggle"><i class="fas fa-bars"></i></button>
        <div class="navbar-brand"><i class="fas fa-calendar-check brand-icon"></i><span class="brand-text">Univents</span></div>
    </div>
    <div class="nav-right">
...
<div class="dashboard-container">
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-menu">
            <a href="dashboard.php" class="menu-item <?php echo basename($_SERVER['PHP_SELF']) == 'dashboard.php' ? 'active' : ''; ?>" data-tooltip="Dashboard"><i class="fas fa-th-large menu-icon"></i><span class="menu-text">Dashboard</span><div class="active-indicator"></div></a>
