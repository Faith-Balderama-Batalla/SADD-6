...
// Officer sidebar navigation - Make sure $user and $unread_count are defined
?>
<nav class="dashboard-navbar">
    <div class="nav-left">
        ...
        <div class="navbar-brand">
            ...
            <span class="brand-text">Univents Officer</span>
        </div>
    </div>
    <div class="nav-right">
            ...
            <div class="sidebar-footer">
                <div class="user-info-mini">
                    ...
                    <div class="user-details-mini">
                        ...
                        <span class="user-role-mini">Organization Officer</span>
                    </div>
