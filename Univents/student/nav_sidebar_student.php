...
// Student sidebar navigation - Make sure $user and $unread_count are defined
?>
        ...
        <div class="user-profile-dropdown">
            <button class="user-profile-btn" id="profileBtn">
                <div class="profile-image">
                    <div class="profile-initials"><?php echo getUserInitials($user); ?></div>
                </div>
...
<div class="dashboard-container">
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="announcements.php" class="menu-item <?php echo basename($_SERVER['PHP_SELF']) == 'announcements.php' ? 'active' : ''; ?>" data-tooltip="Announcements">
                <i class="fas fa-bullhorn menu-icon"></i>
                <span class="menu-text">Announcements</span>
                <div class="active-indicator"></div>
            </a>
            <a href="attendance.php" class="menu-item <?php echo basename($_SERVER['PHP_SELF']) == 'attendance.php' ? 'active' : ''; ?>" data-tooltip="My Attendance">
            ...
            <div class="sidebar-footer">
                <div class="user-info-mini">
                    ...
                    <div class="user-details-mini">
                        <span class="user-name-mini"><?php echo $user['first_name'] . ' ' . $user['last_name']; ?></span>
                        <span class="user-role-mini">Student</span>
                    </div>
